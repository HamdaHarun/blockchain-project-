...
$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productCompany,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount,email) values('$category','$subcat','$productname','$productcompany','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd','$email')");
...
<input type="hidden" name="email"  placeholder="<?php echo htmlentities($_SESSION['login']);?>" value="<?php echo htmlentities($_SESSION['login']);?>" class="span8 tip" required>
</div>
</div>
