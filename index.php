...
<div id="hero" class="homepage-slider3" style="width:1130px">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/mve_o1aa-uz.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on over $ 600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#SPORTS" data-toggle="tab">SPORTS & OUTDOORS</a></li>
					<li><a href="#VIDEO" data-toggle="tab">VIDEO GAMES</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">APPAREL</h3>
